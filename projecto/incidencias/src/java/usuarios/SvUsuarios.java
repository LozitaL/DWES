...
public class SvUsuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        MdUsuarios modelo = new MdUsuarios("jdbc/incidencias");
        
        ArrayList<EntUsuario> arUsuarios = modelo.getUsuarios();
        
        
        request.setAttribute("usuariosActuales", arUsuarios);
        
         // Pasamos el control de la solicitud a fichero usuarios.jsp
        RequestDispatcher dispacher = request.getRequestDispatcher("/vista/usuarios/usuarios.jsp");
